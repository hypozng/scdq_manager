...
public interface OrderCommodityDao extends BasicDao {
    ...
    String INSERT_COLS = "order_id, count, total_price, final_price, remark";

    String SELECT_COLS = "order_id as orderId, count, total_price as totalPrice, final_price as finalPrice, remark, " + COMMON_FIELDS;
    ...
    @Insert("insert into " + TABLE + "(" + INSERT_COLS + ") values(#{commodity.orderId}, #{commodity.count}, " +
            "#{commodity.totalPrice}, #{commodity.finalPrice}, #{commodity.remark})")
